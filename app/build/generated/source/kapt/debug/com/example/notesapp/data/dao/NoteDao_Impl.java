  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`title`,`content`,`imagePath`,`isChecklist`,`checklistItems`,`fontStyle`,`createdAt`,`updatedAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final String _tmp_1 = __converters.fromChecklistItems(entity.getChecklistItems());
        if (_tmp_1 == null) {
        ...
        if (entity.getFontStyle() == null) {
          ...
          statement.bindString(7, entity.getFontStyle());
        }
    ...
    this.__updateAdapterOfNote = new EntityDeletionOrUpdateAdapter<Note>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `notes` SET `id` = ?,`title` = ?,`content` = ?,`imagePath` = ?,`isChecklist` = ?,`checklistItems` = ?,`fontStyle` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
      ...
      public List<Note> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpChecklistItems = __converters.toChecklistItems(_tmp_1);
            final String _tmpFontStyle;
            if (_cursor.isNull(_cursorIndexOfFontStyle)) {
              _tmpFontStyle = null;
            } else {
            ...
            _item = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpImagePath,_tmpIsChecklist,_tmpChecklistItems,_tmpFontStyle,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Note call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmpUpdatedAt = __converters.fromTimestamp(_tmp_3);
            _result = new Note(_tmpId,_tmpTitle,_tmpContent,_tmpImagePath,_tmpIsChecklist,_tmpChecklistItems,_tmpFontStyle,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
